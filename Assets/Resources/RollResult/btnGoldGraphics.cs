...
public class btnGoldGraphics : MonoBehaviour {
    ...
    void Start()
    {
        ...
        btnRollImage.gameObject.transform.localScale = new Vector3(gameObject.transform.localScale.x * 100 / 125, gameObject.transform.localScale.y * 100 / 40, 0);
        btnRollImage.GetComponent<SpriteRenderer>().sprite = Resources.LoadAll<Sprite>("RollResult/btnGold")[0];
    ...
    void Update()
    {
        ...
        {
            btnRollImage.GetComponent<SpriteRenderer>().sprite = Resources.LoadAll<Sprite>("RollResult/btnGoldHover")[0];
        }
    }
